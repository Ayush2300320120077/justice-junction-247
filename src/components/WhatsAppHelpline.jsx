...
export default function WhatsAppHelpline() {
  ...
  return (
    <a
      ...
      className="wa-responsive"
    >
      <WA_ICON />
      <div style={s.tooltip} className="mobile-hide">Chat with us</div>
    </a>
  )
}
...
const s = {
  btn: {
    ...
    border: 'none', boxShadow: '0 8px 24px rgba(37,211,102,0.35)',
    cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
    transition: 'all .4s cubic-bezier(0.34, 1.56, 0.64, 1)',
    textDecoration: 'none',
  },
  tooltip: {
    position: 'absolute', left: 66, background: '#fff', color: '#25D366',
    padding: '.4rem .8rem', borderRadius: '10px', fontSize: '.75rem',
    fontWeight: 800, border: '1px solid #25D366', whiteSpace: 'nowrap',
