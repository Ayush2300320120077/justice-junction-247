...
const s = {
  ...
  code: { fontFamily: "'Playfair Display', serif", fontSize: 'clamp(5rem, 11.3vw, 6.0rem)', fontWeight: 800, background: 'linear-gradient(135deg, var(--bur), var(--gold))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', lineHeight: 1, margin: 0 },
