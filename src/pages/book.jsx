          ...
          <div style={{background: '#fff', padding: '3rem', borderRadius: '32px', border: '1px solid rgba(123, 29, 46, 0.1)', boxShadow: '0 25px 60px rgba(123, 29, 46, 0.05)'}}>
            ...
            <div style={{marginBottom: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem'}}>
              <div className="form-group">
                <label style={{color: '#5A3A42', fontWeight: 700}}>Select Date</label>
                <div style={{position: 'relative', display: 'flex', alignItems: 'center', marginTop: '0.5rem'}}>
                  ...
                  <input type="date" style={{width: '100%', padding: '0.8rem 1rem 0.8rem 2.6rem', border: '1.5px solid rgba(123, 29, 46, 0.1)', borderRadius: 12, outline: 'none', background: '#FDF6EE', color: '#1A0A0D', fontSize: '0.95rem'}} value={formData.date} onChange={e=>setFormData({...formData, date: e.target.value})} min={new Date().toISOString().split('T')[0]} />
                </div>
              </div>
              <div className="form-group">
                ...
                <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginTop: '0.5rem'}}>
                  {['10:00 AM', '11:30 AM', '2:00 PM', '4:30 PM', '6:00 PM'].map(t => (
                    <button 
                      key={t} 
                      style={{padding: '.8rem', borderRadius: 12, border: `1.5px solid ${formData.time === t ? '#7B1D2E' : 'rgba(123, 29, 46, 0.1)'}`, background: formData.time === t ? 'rgba(123, 29, 46, 0.05)' : '#fff', color: formData.time === t ? '#7B1D2E' : '#5A3A42', fontWeight: 800, fontSize: '.85rem', cursor: 'pointer', transition: 'all 0.2s', boxShadow: formData.time === t ? '0 4px 15px rgba(123, 29, 46, 0.1)' : 'none'}}
              ...
              <div className="form-group">
                <label style={{color: '#5A3A42', fontWeight: 700}}>Nature of Case</label>
                <select style={{width: '100%', padding: '0.8rem 1rem', border: '1.5px solid rgba(123, 29, 46, 0.1)', borderRadius: 12, outline: 'none', background: '#FDF6EE', color: '#1A0A0D', fontSize: '0.95rem', marginTop: '0.5rem'}} value={formData.caseType} onChange={e=>setFormData({...formData, caseType: e.target.value})}>
              ...
              <div className="form-group">
                <label style={{color: '#5A3A42', fontWeight: 700}}>Brief Description</label>
                <textarea rows="4" style={{width: '100%', padding: '1rem', borderRadius: 12, border: '1.5px solid rgba(123, 29, 46, 0.1)', outline: 'none', background: '#FDF6EE', color: '#1A0A0D', fontSize: '0.95rem', marginTop: '0.5rem'}} placeholder="Describe your legal issue briefly..." value={formData.description} onChange={e=>setFormData({...formData, description: e.target.value})} />
              </div>
            </div>
          </div>
          ...
          <div style={{position: 'sticky', top: 110, height: 'fit-content'}}>
            <div style={{background: '#FDF6EE', border: '1px solid rgba(123, 29, 46, 0.05)', color: '#1A0A0D', padding: '2.5rem 2rem', borderRadius: '32px', boxShadow: '0 25px 60px rgba(123, 29, 46, 0.05)'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: '1.2rem', paddingBottom: '1.5rem', borderBottom: '1px solid rgba(123, 29, 46, 0.1)'}}>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between'}}><span style={{color: '#5A3A42'}}>Duration</span><span style={{fontWeight: 700}}>30 Mins</span></div>
