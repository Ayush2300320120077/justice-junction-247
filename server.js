...
app.use(require('./api/lawyers'))
app.use(require('./api/bookings'))
app.use(require('./api/payments'))
app.use(require('./api/admin'))
app.use(require('./api/ai'))
app.use(require('./api/cases'))
app.use(require('./api/subscriptions'))
