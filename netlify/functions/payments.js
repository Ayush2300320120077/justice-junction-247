...
const PLATFORM_COMMISSION = 0.10 // 10% commission on each booking
...
router.post('/subscribe', async (req, res) => {
  try {
    ...
    const PLANS = { basic: 99900, pro: 249900, elite: 499900 } // paise
...
router.post('/verify-subscription', async (req, res) => {
  try {
    ...
    lawyer.subscriptionExpiry = new Date(Date.now() + 30 * 24 * 60 * 60 * 1000) // 30 days
...
app.use('/.netlify/functions/payments', router)
